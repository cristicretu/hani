...
<button
 class="bg-bg2 hover:bg-bg3 active:scale-95 transform transition text-primary px-2 py-2 rounded popup-button fixed top-4 right-4 z-50"
...
{#if showPopup}
 <div
  class="fixed popup z-50 top-16 right-4"
